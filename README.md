...
| **[Service Center Assessment](docs/service-center-assessment.md)** | Service center's "non-serviceable key blocks" position, drying analysis showing inadequate cleaning/drying of the ZIF connector, and third service center's claim that keyboard cannot be detached for ultrasonic cleaning (with technical rebuttal) |

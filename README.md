...
| **[Repair Guide](docs/repair-guide.md)** | Recommended next steps (connector confirmed clean → proceed to ultrasonic → replacement), step-by-step plan, and technical notes for the ultrasonic cleaning lab |
